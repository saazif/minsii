...
const styles = {
  ...
  countdownGrid: { display: "flex", alignItems: "center", justifyContent: "center", gap: "8px", flexWrap: "nowwrap", overflowX: "auto" },
  countdownItem: { display: "flex", flexDirection: "column", alignItems: "center", padding: "10px 8px", background: "linear-gradient(135deg, rgba(0,10,30,0.8), rgba(0,20,60,0.6))", border: "1px solid rgba(0,150,255,0.4)", borderRadius: "10px", minWidth: "55px" },
